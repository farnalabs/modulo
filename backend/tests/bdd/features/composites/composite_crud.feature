Feature: Composite Template CRUD
  ...
  Scenario: Create a composite template with parameter ports
    When I POST /api/v1/composite-templates with name "Devil's Advocate" and a sub-pipeline containing agent "critic"
  ...
  Scenario: List all composite templates
    ...
    When I GET /api/v1/composite-templates
  ...
  Scenario: Get composite template by id
    ...
    When I GET /api/v1/composite-templates/00000000-0000-0000-0000-0000000000a1
    Then the response status is 200
    And the response name is "template-a"

  Scenario: Update composite template name and description
    Given org "acme" has composite template "template-a" with id "00000000-0000-0000-0000-0000000000a1"
    When I PATCH /api/v1/composite-templates/00000000-0000-0000-0000-0000000000a1 with new name "updated-name"
    Then the response status is 200
  ...
  Scenario: Delete composite template
    ...
    When I DELETE /api/v1/composite-templates/00000000-0000-0000-0000-0000000000a2
  ...
  Scenario: Org-scoped isolation — cannot see another org's composites
    ...
    When the user from org "othercorp" requests GET /api/v1/composite-templates/00000000-0000-0000-0000-0000000000a3
