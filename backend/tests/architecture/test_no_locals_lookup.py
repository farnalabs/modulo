...
instead of making it explicit. The two occurrences in ``node_runner.py`` and
``api/routes/webhooks.py`` were replaced with pre-initialized locals referenced
directly; this lens guards the class so it cannot regress.
