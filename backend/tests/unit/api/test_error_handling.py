...
SESSION_CASES: list[tuple[str, str, str, type, int, dict | None, str | None]] = [
    ...
    ("env_list_prog", "GET", "/api/v1/environment-profiles", ProgrammingError, 501, None, "database"),
    ("env_list_sqla", "GET", "/api/v1/environment-profiles", SQLAlchemyError, 503, None, "database"),
    (
        "env_create_prog",
        "POST",
    ...
    ("env_get_sqla", "GET", f"/api/v1/environment-profiles/{_PROFILE_ID}", SQLAlchemyError, 503, None, "database"),
    (
        "env_update_prog",
        "PUT",
        f"/api/v1/environment-profiles/{_PROFILE_ID}",
        ProgrammingError,
        501,
        {"name": "x"},
        "database",
