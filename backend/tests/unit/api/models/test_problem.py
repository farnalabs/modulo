...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ProblemType.HITL_GATE_ALREADY_CLAIMED, 409, "Conflict"),
        (ProblemType.HITL_GATE_ALREADY_DECIDED, 409, "Conflict"),
    ...
    ids=(
        ...
        "gone",
        "method_not_allowed",
        "hitl_gate_already_claimed",
        "hitl_gate_already_decided",
