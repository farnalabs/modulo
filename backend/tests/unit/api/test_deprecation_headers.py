...
# Sunset dates must never be relative to "today", or the test rots the moment the
# date passes and the middleware starts (correctly) returning 410 Gone. Any test
# asserting the not-yet-sunset behaviour uses this far-future constant; tests
# asserting the past-sunset behaviour use literal past dates, which cannot rot.
_FUTURE_SUNSET = "2099-12-31"
