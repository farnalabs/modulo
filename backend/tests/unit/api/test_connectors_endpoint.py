...
def _crud_cases() -> list[dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "url": f"/api/v1/connectors/{_CONNECTOR_ID}",
            "body": None,
            "patches": [("soft_delete_connector_instance", True)],
            "expected_status": 204,
        },
        {
            "id": "delete_not_found",
            ...
            "url": f"/api/v1/connectors/{uuid.uuid4()}",
            "body": None,
            "patches": [("soft_delete_connector_instance", False)],
            "expected_status": 404,
        },
        {
            "id": "restore",
            "method": "POST",
            "url": f"/api/v1/connectors/{_CONNECTOR_ID}/restore",
            "body": None,
            "patches": [("restore_connector_instance", _make_connector())],
            "expected_status": 200,
            "check": lambda resp: resp.json()["has_credentials"],
        },
        {
            "id": "restore_not_found",
            "method": "POST",
            "url": f"/api/v1/connectors/{uuid.uuid4()}/restore",
            "body": None,
            "patches": [("restore_connector_instance", None)],
            "expected_status": 404,
        },
    ]
