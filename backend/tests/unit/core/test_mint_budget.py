...
The tests build the budget table by running migration 0241_org_mint_budget_usage
...
_MIGRATION_STEM = "0241_org_mint_budget_usage"
...
class TestMigrationSchema:
    ...
    def test_migration_head_chain(self) -> None:
        module = _load_migration()
        assert module.revision == "0241_org_mint_budget_usage"
        assert module.down_revision == "0240_journey_dismissal"
...
class TestRealPostgresConcurrency:
    ...
    0241_org_mint_budget_usage (the FK to ``organisations`` is deliberately
