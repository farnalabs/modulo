...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # and 0230_add_updated_at_audit_to_organisations chains on top of 0229,
        # and 0231_add_organisations_indexes chains on top of 0230,
        # and 0232_promote_organisations_json_to_jsonb chains on top of 0231,
        # and 0233_add_organisations_constraints chains on top of 0232,
        # and 0234_fix_token_family_org_nullable chains on top of 0233,
        # so it is now the single linear head of the chain.
        assert heads == ["0234_fix_token_family_org_nullable"], f"expected a single head, got {heads}"
