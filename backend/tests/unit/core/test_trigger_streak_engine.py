...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # and 0232_journey_dismissal chains on top of 0231_token_families_reuse_replay_count,
        # and 0233_org_mint_budget_usage chains on top of 0232_journey_dismissal,
        # so it is now the single linear head.
        assert heads == ["0233_org_mint_budget_usage"], f"expected a single head, got {heads}"
