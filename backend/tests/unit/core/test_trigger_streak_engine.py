...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # and 0243_drop_organisations_audit_columns chains on top of 0242_org_mint_budget_usage,
        # so it is now the single linear head of the chain.
        assert heads == ["0243_drop_organisations_audit_columns"], f"expected a single head, got {heads}"
