...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # 0195, and FAR-760's 0204_library_collection_type chains on top of
        # 0203_triggers_add_name, so it is now the single linear head of the chain.
        assert heads == ["0204_library_collection_type"], f"expected a single head, got {heads}"
