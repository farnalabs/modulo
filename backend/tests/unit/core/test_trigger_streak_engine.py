...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # 0209_collection_install_id_entity_columns chains on top of 0208,
        ...
        # and 0232_seed_modulo_sentinel_organisation chains on top of 0231_token_families_reuse_replay_count,
        # and 0233_add_updated_at_audit_to_organisations chains on top of 0232_seed_modulo_sentinel_organisation,
        # and 0234_add_organisations_indexes chains on top of 0233_add_updated_at_audit_to_organisations,
        # and 0235_promote_organisations_json_to_jsonb chains on top of 0234_add_organisations_indexes,
        ...
        # chains on top of 0248_agent_schema_profile, and 0250_schema_enforcement_telemetry
        # (FAR-902) chains on top of 0249_validation_level, and 0250b_enforcement_daily_facts
        # (FAR-902) chains on top of 0250_schema_enforcement_telemetry, and
        # 0251_runs_enforcement_mode_outcome (FAR-902) chains on top of
        # 0250b_enforcement_daily_facts, so it is now the single linear head of the chain.
        assert heads == ["0251_runs_enforcement_mode_outcome"], f"expected a single head, got {heads}"
