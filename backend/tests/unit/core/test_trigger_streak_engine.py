...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # and 0241_drop_organisations_audit_columns chains on top of 0240_reinstate_organisations_audit_columns,
        # so it is now the single linear head of the chain.
        assert heads == ["0241_drop_organisations_audit_columns"], f"expected a single head, got {heads}"
