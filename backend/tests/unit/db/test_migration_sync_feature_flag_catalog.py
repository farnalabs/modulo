...
current head of the chain (0080_add_mobile_sidebar_rail_flag, on top of
0079_schema_folders) — so the head property holds against the current chain.
"""
...
_HEAD_MIGRATION_NAME = "0080_add_mobile_sidebar_rail_flag"
