...
from modulo.db.crud.scheduled_report import create_scheduled_report
...
def test_cost_report_compatibility_properties_read_canonical_json() -> None:
    report = ScheduledReport(
        ...
        recipient_config={"emails": ["admin@example.com", 42]},
    )
...
async def test_create_cost_report_maps_to_scheduler_schema() -> None:
    ...
    assert report.recipient_config == {"emails": ["owner@example.com"]}
