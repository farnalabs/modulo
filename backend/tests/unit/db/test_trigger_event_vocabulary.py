...
# and 0226_agents_json_to_jsonb chained onto 0225, and FAR-802's
# 0227_add_workspace_inputs_count chained onto 0226 as the chain head.
_CHAIN_HEAD_MIGRATION_NAME = "0227_add_workspace_inputs_count"
