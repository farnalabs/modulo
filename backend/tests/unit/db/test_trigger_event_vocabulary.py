...
# and 0228_agents_unique_organisation_name chained onto
# 0227_env_profiles_initialisation_strategy_check as the chain head.
_CHAIN_HEAD_MIGRATION_NAME = "0228_agents_unique_organisation_name"
