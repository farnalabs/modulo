...
# and 0227_env_profiles_initialisation_strategy_check chained onto 0226_agents_json_to_jsonb as the chain head.
_CHAIN_HEAD_MIGRATION_NAME = "0227_env_profiles_initialisation_strategy_check"
