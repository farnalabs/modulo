...
# 0190_hitl_claim_context_json (main, FAR-613) re-parents onto 0189,
# 0191_bundled_runner_seed_backfill re-parents onto 0190, and this PR's
# 0192_uuid_pk_server_defaults (FAR-718) chains off 0191 as the chain head).
_CHAIN_HEAD_MIGRATION = "0192_uuid_pk_server_defaults"
