...
# and 0227_env_profiles_initialisation_strategy_check chains off 0226,
# and 0230_journey_dismissal chains off 0228_drop_scalar_agent_command as the chain head.
_CHAIN_HEAD_MIGRATION = "0230_journey_dismissal"
