...
# and 0228_drop_scalar_agent_command chains off 0227_env_profiles_initialisation_strategy_check as the chain head.
_CHAIN_HEAD_MIGRATION = "0228_drop_scalar_agent_command"
