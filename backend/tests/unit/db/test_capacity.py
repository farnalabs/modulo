...
@pytest.mark.parametrize(
    ("percent", "expected"),
    [
        pytest.param(None, "ok", id="unknown_ok"),
        pytest.param(0.0, "ok", id="empty_ok"),
        pytest.param(79.9, "ok", id="below_warn_ok"),
        pytest.param(80.0, "warn", id="at_warn"),
        pytest.param(89.9, "warn", id="below_critical_warn"),
        pytest.param(90.0, "critical", id="at_critical"),
        pytest.param(97.9, "critical", id="below_hard_stop_critical"),
        pytest.param(98.0, "full", id="at_hard_stop"),
        pytest.param(100.0, "full", id="at_100_full"),
    ],
    ids=[
        "none_ok",
        "zero_ok",
