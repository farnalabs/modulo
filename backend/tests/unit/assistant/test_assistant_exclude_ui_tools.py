"""Unit coverage for the assistant-only stream mode (exclude_ui_tools flag, FAR-109).
...
async def _run_stream(
    *,
    ...
    patches = [
        ...
        patch("modulo.api.routes.assistant._get_all_tool_definitions", tool_defs_mock),
        patch(
            "modulo.api.routes.assistant._is_ui_driving_enabled",
