"""Unit tests for Assistant UI tools — tool definitions, permission resolution, session approvals."""
...
from modulo.core.assistant.config_service import (
...
class TestPermissionResolution:
    """Tests for _resolve_tool_permission logic via AssistantConfig."""
    ...
    def test_permission_for_mode(self, mode: str, tool: str, selector: str | None, expected: str):
        config = AssistantConfig(permission_mode=mode)
    ...
    def test_locked_down_write_tools_remain_requires_approval_with_destructive(self):
        config = AssistantConfig(permission_mode="locked_down")
    ...
    def test_per_tool_override(self):
        config = AssistantConfig(tool_permissions={"click": "disabled"})
...
class TestSessionApproval:
    def setup_method(self) -> None:
        ...
        self._registry_patcher = patch("modulo.api.routes.assistant._get_registry", return_value=None)
