...
ACCOUNTS_FKS: tuple[tuple[str, str, str, str], ...] = (
    ...
    (
        ...
        "primitive_abuse_reports_reviewer_account_id_fkey",
        "reviewer_account_id",
        ON_DELETE_SET_NULL,
    ),
    (
        "primitive_abuse_reports",
        "primitive_abuse_reports_reporter_account_id_fkey",
        "reporter_account_id",
        ON_DELETE_SET_NULL,
    ),
    ("primitive_ratings", "primitive_ratings_account_id_fkey", "account_id", ON_DELETE_SET_NULL),
    ("assistant_context_sources", "assistant_context_sources_account_id_fkey", "account_id", ON_DELETE_CASCADE),
    ("assistant_skills", "assistant_skills_account_id_fkey", "account_id", ON_DELETE_CASCADE),
