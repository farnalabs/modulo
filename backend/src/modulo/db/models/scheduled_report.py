...
class ScheduledReport(OrgScoped):
    ...
    config_json: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=None)
    recipient_config: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=None)
