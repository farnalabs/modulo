...
Revision ID: 0239_org_mint_budget_usage
Revises: 0238_journey_dismissal
...
revision: str = "0239_org_mint_budget_usage"
down_revision: str | None = "0238_journey_dismissal"
