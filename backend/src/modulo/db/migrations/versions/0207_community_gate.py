...
Revision ID: 0207_community_gate
Revises: 0206_collection_install_tracking
...
revision: str = "0207_community_gate"
down_revision: str | None = "0206_collection_install_tracking"
