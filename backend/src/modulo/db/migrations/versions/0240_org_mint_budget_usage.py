...
Revision ID: 0240_org_mint_budget_usage
Revises: 0239_journey_dismissal
...
revision: str = "0240_org_mint_budget_usage"
down_revision: str | None = "0239_journey_dismissal"
