...
Revision ID: 0230_agents_unique_organisation_name
...
This revision chains on top of ``0229_add_workspace_inputs_count`` (FAR-802), so
...
revision: str = "0230_agents_unique_organisation_name"
