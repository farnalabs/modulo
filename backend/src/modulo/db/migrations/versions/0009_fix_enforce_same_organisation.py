...
def upgrade() -> None:
    ...
    print("  Replaced enforce_same_organisation with column-existence guard")
...
def downgrade() -> None:
    ...
    print("  Restored original enforce_same_organisation (broken for non-org-scoped parents)")
