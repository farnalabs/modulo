...
Revision ID: 0160_invitations
Revises: 0159_accounts_must_change_password
...
revision: str = "0160_invitations"
down_revision: str | None = "0159_accounts_must_change_password"
