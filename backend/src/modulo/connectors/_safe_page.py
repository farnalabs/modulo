...
CircleCI (``items``), n8n (``data``), Opsgenie (``data``), and Datadog
(``data``) connectors each guard their list parsing against corrupt or
hostile response bodies. A corrupt or hostile response may return
