...
class GitHubConnector(ConnectorBase):
    ...
    def _jitter(delay: float, *, tight: bool = False) -> float:
        ...
        """
        if tight:
            return random.uniform(delay * 0.9, delay)  # nosec B311 — non-cryptographic jitter for retry delays
        return random.uniform(0, delay)  # nosec B311 — non-cryptographic jitter for retry delays
