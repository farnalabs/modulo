"""GroqBackend — wraps ChatOpenAI pointed at Groq's OpenAI-compatible endpoint."""
...
class GroqBackend(ModelBackendBase):
    """Thin adapter over ChatOpenAI targeting Groq's OpenAI-compatible API."""
