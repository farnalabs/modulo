...
farnalabs-internal. See `Repos/devtools/AGENTS.md` (moved in FAR-287).
...
farnalabs-internal (Linear farnalabs-modulo workspace). See `Repos/devtools/AGENTS.md` (moved in FAR-287).
...
farnalabs-internal (our E2B sandbox agent pipelines). See `Repos/devtools/AGENTS.md` (moved in FAR-287).

### After raising a PR, poll checks until they pass or fail

farnalabs-internal delivery process. See `Repos/devtools/AGENTS.md` (moved in FAR-287).

### Worker restricted-scope contract

farnalabs-internal delivery process. See `Repos/devtools/AGENTS.md` (moved in FAR-287).

## Reviewer first-pass quality

farnalabs-internal (PR Reviewer pipeline guidance). See `Repos/devtools/AGENTS.md` (moved in FAR-287).
