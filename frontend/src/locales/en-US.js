export default {
  ...
  "views": {
    ...
    "LibraryView": {
      ...
      "type_library_collections": "Collections",
      ...
      "collection_status_published": "Published",
      "collection_create_title": "Create Collection",
      "collection_name": "Name",
      "collection_slug": "Slug",
      "collection_description": "Description (optional)",
      "collection_manifest_pins": "Manifest Pins",
      "collection_add_pin": "Add Pin",
      "collection_pin_slug": "Pin Slug",
      "collection_pin_version": "Pin Version",
      "collection_remove_pin": "Remove pin",
      "collection_publish": "Publish",
      "collection_publishing": "Publishing...",
      "collection_published": "Collection published successfully",
      "collection_draft_detail": "Draft Collection",
      "collection_empty_pins": "No pins added yet. Add primitives to this collection.",
      "collection_pin_limit": "Maximum {limit} pins allowed",
      "collection_visibility": "Visibility",
      "collection_visibility_org": "Org",
    ...
    "AdminAssistantView": {
      "configure_assistant_ai_assistant_behaviour_access_and_skills": "Configure the Modulo assistant behaviour, access, and skills",
      ...
      "control_who_can_use_assistant_within_the_organisation": "Control who can use Assistant within the organisation",
      ...
      "users_with_the_selected_organisation_roles_will_have_access_": "Users with the selected organisation roles will have access to Assistant. Admin is selected by default.",
      "default_model_configuration": "Default Model Configuration",
      "allowed_providers": "Allowed Providers",
      "api_key_configured_assistant_can_route_to": "API key configured — Assistant can route to",
      "can_create_and_manage_pipelines_use_assistant": "Can create and manage pipelines, use Assistant.",
      "failed_to_toggle_skill": "Failed to toggle skill:",
      "base_system_prompt_that_guides_assistants_behaviour": "Base system prompt that guides Assistant's behaviour",
      ...
      "save_the_base_system_prompt_that_guides_assistants_behaviour": "Save the base system prompt that guides Assistant's behaviour.",
      "allowed_models": "Allowed Models",
      "default_provider": "Default Provider",
      "save_current_access_list_configuration": "Save current access list configuration.",
      "skill_description": "Skill description",
      "set_the_default_model_and_allowed_providers_for_assistant": "Set the default model and allowed providers for Assistant",
      "teams": "Teams",
      ...
      "no_users_selected": "No users selected — all org members can use Assistant",
      "api_keys_configured_for_each_llm_provider_assistant_will_use_thes": "API keys configured for each LLM provider — Assistant will use these to route requests",
      "additional_instructions": "Additional instructions...",
      "delete_skill": "Delete skill",
      "access_list": "Access List",
      "save_system_prompt": "Save System Prompt",
      "no_api_key_set_assistant_will_skip": "No API key set. Assistant will skip",
      "assistant_configuration": "Assistant Configuration",
      "can_execute_pipeline_runs_use_assistant": "Can execute pipeline runs, use Assistant.",
      "save_access_list": "Save Access List",
      "org_roles": "Org Roles",
      "failed_to_load_assistant_config": "Failed to load Assistant config:",
      "add_edit_or_remove_api_keys_for_llm_providers": "Add, edit, or remove API keys for LLM providers.",
      "organisationlevel_skills_that_assistant_can_use": "Organisation-level skills that Assistant can use",
      ...
      "readonly_access_can_view_but_not_edit_use_assistant": "Read-only access — can view but not edit, use Assistant.",
      "full_access_to_all_settings_and_assistant_configuration": "Full access to all settings and Assistant configuration.",
      ...
      "control_what_assistant_knows": "Control what Assistant knows and how it loads that knowledge.",
      "source": "Source",
      "mode": "Mode",
      "tokens": "Tokens",
      "always_on": "Always On",
      ...
      "product_primer_description": "A brief primer on what your product does, loaded at the start of every Assistant session.",
      "page_context_description": "Context from the current page Assistant is operating on.",
      ...
      "users_with_the_selected_organisation_roles_will_have_access": "Users with the selected organisation roles will have access to Assistant.",
      ...
      "maximum_number_of_ui_actions_assistant_can_perform_in_a_one_minute_window": "Maximum number of UI actions Assistant can perform in a one-minute window.",
      ...
      "url_patterns_comma_separated_that_assistant_must_never_navigate_to_supports_wildcards": "URL patterns (comma-separated) that Assistant must never navigate to. Supports wildcards.",
      "css_selector_patterns_comma_separated_for_elements_assistant_must_never_interact_with": "CSS selector patterns (comma-separated) for elements Assistant must never interact with.",
      "allowed_css_selectors": "Allowed CSS Selectors",
      "when_set_assistant_can_only_interact_with_elements_matching_these_css_selectors_or_data_testid_prefixes_leave_empty_to_allow_all": "When set, Assistant can ONLY interact with elements matching these CSS selectors or data-testid prefixes. Leave empty to allow all.",
      "allowed_page_url_patterns": "Allowed Page URL Patterns",
      "when_set_assistant_can_only_navigate_to_pages_matching_these_url_patterns_leave_empty_to_allow_all": "When set, Assistant can ONLY navigate to pages matching these URL patterns. Leave empty to allow all.",
      "name": "Name",
      "triggers": "Triggers",
      "active": "Active",
      "actions": "Actions",
      ...
      "not_set": "Not set",
      "providers_loading": "Loading provider status...",
      "no_custom_backends_configured": "No custom backends configured.",
      "manage_all_backends_in_model_backends": "Manage all backends in Model Backends ?",
      "model_name_placeholder": "claude-sonnet-4-20250514",
      "context_window_placeholder": "200000",
      "rate_limit_max_actions_placeholder": "30",
      "rate_limit_window_seconds_placeholder": "60",
      "nogo_page_patterns_placeholder": "/admin/settings/billing, /security*",
      "nogo_selector_patterns_placeholder": "[data-testid=delete-account], .danger-zone button",
      "allowed_selectors_placeholder": "[data-testid=pipeline-], .btn-primary",
      "allowed_page_url_patterns_placeholder": "/admin/pipelines, /admin/schemas",
      "tool_permissions": "Tool Permissions",
      "tool_permissions_description": "Control which UI actions Assistant can perform and whether approval is required.",
      "tool_permission": "Tool permission",
      "mode_safe": "Safe – read ops auto-allowed, destructive actions require approval (recommended)",
      "mode_full_auto": "Full Auto – all actions auto-allowed (with destructive override)",
      "mode_locked_down": "Locked Down – all write actions require approval",
      "mode_custom": "Custom – manual per-tool configuration",
      "save_tool_permissions": "Save Tool Permissions",
      "safety_and_limits": "Safety & Limits",
      "safety_and_limits_description": "Configure rate limits, auto-execution thresholds, and no-go patterns for Assistant's browser automation.",
      "auto_execute_threshold_description": "Minimum confidence score (0.0–1.0) required for Assistant to auto-execute an action without approval.",
      "save_safety_config": "Save Safety Config",
      "skills": "Skills",
      "add_skill": "Add Skill",
      "inactive": "Inactive",
      "create_skill_description": "Create a new organisation-level skill for Assistant.",
      "edit_skill_description": "Update the skill configuration.",
      "context_source_mode": "Context source mode",
      "skill_knowledge_mode": "Skill knowledge mode",
      "regenerating": "Regenerating...",
      "member_count": "{count} members | {count} member | {count} members",
      "failed_to_save": "Failed to save",
      "failed_to_save_access_list": "Failed to save access list:",
      "failed_to_save_model_config": "Failed to save model config:",
      "failed_to_save_system_prompt": "Failed to save system prompt:",
      "failed_to_save_safety_config": "Failed to save safety config:",
      "failed_to_save_guidance": "Failed to save guidance:",
      "failed_to_save_source": "Failed to save source:",
      "failed_to_save_skill_source_mode": "Failed to save skill source mode:",
      "failed": "Failed",
      "context_source_primer_label": "Product Primer",
      "context_source_page_label": "Page Context",
      "context_source_user_profile_label": "User Profile",
      "context_source_product_docs_label": "Product Docs",
      "context_source_integration_status_label": "Integration Status",
      "context_source_org_config_label": "Org Config",
      "context_source_feature_overview_label": "Feature Overview",
      "tool_navigate": "Navigate to a page",
      "tool_click": "Click a button or link",
      "tool_fill": "Type into a form field",
      "tool_select": "Choose a dropdown option",
      "tool_extract": "Read text from the page",
      "tool_extract_all": "Read text from all matching elements",
      "tool_get_page_interactables": "Discover clickable elements on the page",
      "tool_wait": "Pause or wait for an element",
      "tool_go_back": "Go back to previous page",
      "tool_get_url": "Get current page URL",
      "tool_press": "Press a keyboard key (Enter, Escape)"
    },
    "PipelineListView": {
      "title": "Pipelines",
    ...
    "SettingsHitlReviewView": {
      ...
      "bulk_selected": "{count} gate selected | {count} gates selected",
      "bulk_claim": "Bulk Claim",
      "bulk_claiming": "Claiming...",
      "bulk_reject": "Bulk Reject",
      "bulk_clear": "Clear Selection",
      "bulk_reject_reason_label": "Rejection reason (applies to all selected gates)",
      "bulk_reject_reason_placeholder": "Why are you rejecting these gates?",
      "bulk_reject_confirm": "Reject All",
      "bulk_rejecting": "Rejecting...",
      "bulk_reject_cancel": "Cancel",
      "bulk_outcomes_title": "Results:",
      ...
      "bulk_select_all": "Select all gates on this page",
      "bulk_select_gate": "Select gate {id}",
      "bulk_claim_partial_failure": "Some gates could not be claimed: {errors}",
      "bulk_reject_partial_failure": "Some gates could not be rejected: {errors}"
    },
    ...
    "PipelineEditorView": {
      ...
      "new_node_type_hint": "Choose the type of node to add to the pipeline",
      "no_limit": "No limit",
      "agent_select_label": "Agent to convert to",
      "agent_select_hint": "The agent this manual node becomes when converted",
      "prompt": "Prompt",
      "label": "Label",
      "description": "Description",
      "template": "Template",
      ...
      "env_vars": "Env Vars",
      "runner_bindings": "Runner Bindings",
      "runner_bindings_help": "Inject a Model Backend credential into this agent's runner env (configure once, reuse everywhere). The node's Env Vars still win.",
      "runner_bindings_none": "No runner bindings on this agent.",
      "runner_bindings_backend": "Model backend",
      "runner_bindings_backend_placeholder": "Backend",
      "runner_bindings_target": "Target env var",
      "runner_bindings_target_placeholder": "TARGET_ENV_VAR",
      "runner_bindings_source": "Source field",
      "runner_bindings_source_placeholder": "api_key",
      "runner_bindings_add": "Add binding",
      ...
      "retry_policy_description": "Automatically re-dispatch a run that ends in a retryable state (up to the retry budget).",
      ...
      "retry_policy_warning_no_max": "With Max retries at 0, no run will ever be retried — set it to at least 1.",
      "retry_policy_mode_label": "Retry coverage",
      "retry_policy_mode_all": "All errors",
      "retry_policy_mode_specific": "Choose specific errors",
      "retry_policy_warning_no_events": "No events selected. Nothing will retry: select at least one event or switch to All errors.",
    ...
    "RunsListView": {
      ...
      "status_eval_failed": "Eval Failed",
    ...
    "DashboardView": {
      ...
      "configure_ai_provider_description": "Enable the Modulo assistant by configuring an AI provider",
    ...
    "RunDetailView": {
      ...
      "total_tokens_node_reported": "{count} tokens reported by nodes",
      "total_tokens_not_reported_by_nodes": "{count} tokens reported in cost basis (nodes did not report per-node totals)",
      ...
      "log_truncated_shown_of": "Showing {shown} of {total} characters. Full log available via download below.",
      "runs": "Runs",
      "gate_label": "Gate:",
      "workspace": "Workspace",
      "status_label": "Status:",
      ...
      "warnings_strip_guardrail_override": "A guardrail override is available for this blocked run.",
      "warnings_strip_stale_heartbeat": "Heartbeat is stale — the agent may have stopped reporting.",
      ...
      "full_logs": "Full Logs",
      "full_log_download_hint": "Download the full log to view the complete output — the inline view is truncated.",
      "pretty_print": "Pretty print",
      "pretty_print_toggle": "Toggle pretty print for log output",
      "strip_ansi": "Strip colours",
      "strip_ansi_toggle": "Strip ANSI colour codes from log output",
    ...
    "AdminRunRetentionView": {
      ...
      "page_subtitle": "Export old runs to a file, then clear them down across checkpoints",
      ...
      "all_statuses": "All statuses",
      "reset": "Reset",
      "warning_terminal_only": "Only terminal runs (complete, failed, cancelled, eval-failed, stalled, budget-exceeded) are ever purged. In-flight runs (pending, running, awaiting human, claimed) are never deleted — they are listed as candidates but are skipped by the purge.",
      ...
      "no_runs_match_change_filters": "Adjust the date, pipeline, or status filters to find purgable runs.",
      "bytes_zero": "0 B",
    ...
    "AdminRunnersView": {
      ...
      "tab_concurrency": "Concurrency"
    },
    "RunnersStatusStrip": {
      "healthy": "\u2713 healthy",
      "not_enabled": "not enabled on this deployment",
    ...
    "RunnersProfilesTab": {
      ...
      "health_unreachable": "engine unreachable",
      "health_image_missing": "image not pulled",
      "health_unknown": "status unknown",
      "template_updated": "Shipped template updated",
      "template_updated_hint": "The bundled runner template shipped with this release differs from this profile. Applying refreshes template-owned fields only.",
      "apply": "Apply",
      "edit": "Edit",
      "delete_profile": "Delete profile",
      "template_delete_protected": "The seeded template profile cannot be deleted",
      "delete_confirm": "Delete \"{name}\"?",
      "soft_delete_warning": "The profile is soft-deleted and can be restored by an admin.",
      "delete": "Delete",
      "deleting": "Deleting...",
    ...
    "RunnersConcurrencyTab": {
      ...
      "effective_default": "{value} (default)",
      "effective_no_gate": "No gate — unlimited concurrent Runner dispatches",
      "effective_deny_all": "0 — deny-all: new Runner dispatches are refused",
      "effective_explicit": "{value} concurrent Runner dispatch(es)",
      "semantics_full": "Default (unset) = 4 for the Docker tier. An explicit value gates all tiers. 0 denies all dispatches. Empty disables the gate.",
      "preflight_ok": "Engine resources can host the configured concurrency.",
      "preflight_exceeds_cpu": "\u26a0 The concurrency cap exceeds the engine's CPU capacity.",
      "preflight_exceeds_mem": "\u26a0 The concurrency cap exceeds the engine's memory capacity.",
      "preflight_exceeds_both": "\u26a0 The concurrency cap exceeds both the engine's CPU and memory capacity.",
      "preflight_uncapped": "Uncapped — cannot assess host headroom.",
      "preflight_unknown": "Engine resources unknown (no recent health probe).",
      "engine_resources": "Engine: {cpu} CPU / {mem} MiB",
      "needed_resources": "needed at cap: {cpu} CPU / {mem} MiB"
    },
    ...
    "AdminCostBreakdownView": {
      ...
      "total_runs": "Total Runs",
      "cost_per_successful_run": "Cost per Successful Run",
      "successful_runs_count": "{count} successful run | {count} successful runs",
      "no_successful_runs": "No successful runs in this period",
    ...
    "AdminNotificationDeliveryLogView": {
      ...
      "notification_delivery_log": "Webhook Notifications",
    ...
    "SettingsMcpView": {
      ...
      "configure_mcp_server_settings_and_api_keys": "Configure Model Context Protocol (MCP) server settings and API keys",
      ...
      "key_placeholder_example": "e.g. Claude Desktop",
      "api_key_created": "API Key Created",
      "copy_key_now_warning": "Copy this key now. You will not be able to see it again.",
      "api_key": "API Key",
      "key_will_be_masked_in": "This key will be masked in {seconds}s",
      "revoke_api_key": "Revoke API Key",
      "revoke_key_confirmation_part1": "Are you sure you want to revoke the key",
      "revoke_key_confirmation_part2": "Any clients using this key will lose access immediately."
    },
    "UserAssistantSkillsView": {
      "my_assistant_skills": "My Assistant Skills",
      "manage_your_personal_skills_for_the_assistant_ai_assistant": "Manage your personal skills for the Modulo assistant",
    ...
    "OnboardingWizard": {
      ...
      "wizard_guide_steps": "7 quick steps",
      ...
      "telemetry_subtitle": "Help us improve Modulo with anonymous usage data",
      "telemetry_heading": "Help Improve Modulo",
      "telemetry_description": "Modulo can send anonymous, aggregated usage data to help us understand how the product is used and where to focus development effort. This is entirely optional.",
      "telemetry_what_sent": "If you opt in, we collect:",
  ...
  "assistant": {
    ...
    "AdminConnectorsView": {
      "title": "Connectors",
      "subtitle": "Manage connector instances for data source integration",
      "add_connector": "Add Connector",
      "add_a_connector_to_integrate": "Add a connector to integrate with external data sources.",
      "create": "Create",
      "creating": "Creating...",
      "save": "Save",
      "saving": "Saving...",
      ...
      "disabled": "Disabled",
      "edit": "Edit",
      "please_fix": "Please fix the highlighted configuration fields.",
      "delete_confirm": "Delete \"{name}\"?",
      "failed_to_load_connectors": "Failed to load connectors:",
      ...
      "name_placeholder": "My connector",
      "type_placeholder": "PostgreSQL",
      "description_placeholder": "Optional description",
    ...
    "variantCreator": {
      ...
      "aria_min_variants": "Minimum variants",
    ...
    "AdminUsersView": {
      ...
      "mode_invite": "Invite",
      "invite_mode_hint": "No password needed — you will get a one-time invite link to share with the user.",
      "send_invitation": "Send Invitation",
      "invite_user": "Invite User",
      "invitation_sent": "Invitation created for {email}",
      "failed_to_send_invitation": "Failed to send invitation",
      "deactivate": "Deactivate",
      "reactivate": "Reactivate",
      "user_created": "User {email} created",
      "user_deactivated": "User {email} deactivated",
      "user_reactivated": "User {email} reactivated",
      "role_changed_to": "Role changed to {role} for {email}",
      "copy": "Copy",
      "copy_failed_manual": "Copy failed — select the value above and copy it manually.",
      "done": "Done",
      "invitation_ready": "Invitation Ready",
      "invitation_link_created_for": "Send this one-time invite link to {email}. It is shown only once.",
      "invite_qr_alt": "QR code for the invite link",
      "invite_expiry_note": "This link expires on {expires} and can be used once.",
      "pending_invitations": "Pending Invitations",
      "no_pending_invitations": "No pending invitations.",
      "invited_col": "Invited",
      "expires_col": "Expires",
      "revoke_invitation": "Revoke",
      "confirm_revoke_invitation": "Revoke the invitation for {email}? They will no longer be able to use the invite link.",
      "invitation_revoked": "Invitation for {email} revoked",
      "failed_to_revoke_invitation": "Failed to revoke invitation"
    },
    "AcceptInviteView": {
      "title": "Accept Invitation",
      "subtitle": "Choose a password for your account to join your team.",
      "missing_token": "This invitation link is incomplete. Ask your administrator for a fresh link.",
      "password_label": "New password",
      "confirm_label": "Confirm password",
      "requirement_length": "At least 8 characters",
      "requirement_mixed": "Upper and lower case letters and at least one digit",
      "mismatch_error": "Passwords do not match",
      "submit_button": "Set Password & Join",
      "submitting_button": "Setting password...",
      "success_message": "Your account is ready! Redirecting you to sign in...",
      "existing_success_message": "Membership added. Use your existing password to sign in.",
      "invalid_token_error": "Invalid or expired invitation."
    },
    "SettingsTeamsView": {
      "page_title": "Teams",
      "page_subtitle": "Manage teams and team membership",
      "create_team": "Create Team",
      "failed_to_load_teams": "Failed to load teams:",
      "new_team": "New Team",
      "name": "Name",
      "description": "Description",
      "placeholder_name": "e.g. Platform Engineering",
      ...
      "rename": "Rename",
      "remove": "Remove",
      "remove_member_confirm": "Remove this member from the team?",
      ...
      "aria_label_member_role": "Member role",
      "aria_label_select_user": "Select user",
      "aria_label_select_role": "Select role"
    },
    "SettingsSsoView": {
    ...
    "variantCompare": {
      ...
      "emptyGroupsTitle": "Variant Groups",
      "emptyGroupsDescription": "No variant groups found. Create a comparison to run a pipeline as weighted variants and compare model outputs side by side.",
    ...
    "variantBatch": {
      ...
      "statusHeader": "Status",
      "aria_partial_results": "Partial results",
      "aria_batch_failed": "Batch failure notice",
      "passRate": "Pass Rate",
      "cost": "Cost",
      "runs": "runs",
      ...
      "viewRun": "Open run",
      "evals": "Evals",
      "tokensByNode": "Token usage per node",
      "node": "Node",
      "inputTokens": "Input",
      "outputTokens": "Output",
      "totalTokens": "Total",
  ...
  "components": {
    ...
    "AppLayout": {
      ...
      "assistant_performing_actions": "Assistant is performing actions on this page",
      "assistant_stop": "Stop",
      "modulo": "Modulo",
    ...
    "assistant": {
      ...
      "AssistantChat": {
        ...
        "intro_text": "Hi! I'm your Modulo assistant. I can help you build pipelines, run evaluations, manage your workspace, and answer questions about your data. What would you like help with?",
        "permission_request": "Assistant wants to perform actions on your behalf",
      ...
      "AssistantContextSources": {
        "knowledge_sources": "Knowledge Sources",
        "description": "Customise what Assistant knows about your organisation. Changes apply to new conversations only.",
        "source": "Source",
        "mode": "Mode",
        "always_on": "Always On",
        "tool": "Tool",
        ...
        "legend_tool": "Tool = Assistant loads on demand",
        "legend_off": "Off = disabled"
      },
      "AssistantOnlyView": {
        "assistant_title": "Assistant",
        "assistant_only_mode": "Assistant Only Mode",
        "banner": "This is a chat-only view — Assistant can answer questions and use your skills, but cannot drive the browser here.",
        ...
        "assistant_unavailable": "Assistant is unavailable",
        "assistant_unavailable_desc": "Assistant Only mode is not enabled for your workspace. Enable dev mode to use it."
      }
    },
    "SsoProviderForm": {
      "client_id": "Client ID",
      ...
      "mode_invitation_help": "Only existing members or users with a pending invitation can sign in.",
      "mode_domains": "Email domain allowlist",
      "mode_domains_help": "Anyone who authenticates at the IdP with a matching verified email domain is provisioned. Matching is exact and case-insensitive, with no implicit subdomain matching.",
      "mode_unrestricted": "Anyone who authenticates",
      "mode_unrestricted_help": "Auto-provisions any authenticated identity into the organisation.",
      ...
      "allowed_domains_help": "Type or paste comma- or space-separated domains and press Enter (or blur). Matching ignores case — subdomains are not included automatically, so list each one explicitly (e.g. example.com, mail.example.com).",
      ...
      "domain_invalid_no_dot": "A registrable domain must contain a dot (e.g. example.com)",
      ...
      "tenant_placeholder_auth0": "e.g. acme.auth0.com",
      "tenant_placeholder_okta": "e.g. acme.okta.com",
      "tenant_placeholder_azure_ad": "e.g. contoso.onmicrosoft.com",
      "tenant_placeholder_onelogin": "e.g. acme",
...
"previous": "Previous",
  ...
  "connectors": {
    "rest": {
      ...
      "method": "Method",
      "method_invalid": "Invalid method {method}; expected one of {options}",
      "path": "Path",
      "headers": "Headers",
      "params": "Query params",
      "body": "Body",
      ...
      "auth_mode": "Auth mode",
      "auth_mode_invalid": "Invalid auth_mode {value}; expected one of bearer, api_key, basic",
      ...
      "on_unknown": "Duplicate-write policy",
      ...
      "on_unknown_off": "off",
      "on_unknown_fail_open_help": "Re-fire the write when the previous attempt's delivery could not be confirmed. A duplicate delivery is possible; a silent miss is not.",
      "on_unknown_fail_closed_help": "Suppress the write when the previous attempt's delivery could not be confirmed. No duplicate delivery; a silent miss is possible.",
      "on_unknown_off_help": "Disable duplicate-write suppression for this connector's writes entirely.",
