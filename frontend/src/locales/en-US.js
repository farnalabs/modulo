export default {
  ...
  "remy": {
    ...
    "AdminConnectorsView": {
      ...
      "manage_connector_instances_for_data_source_integration": "Manage connector instances for data source integration",
      "add_connector": "Add Connector",
      "name": "Name",
      "type": "Type",
      "description": "Description",
      ...
      "enabled": "Enabled",
      "disabled": "Disabled",
      "add_connector_hint": "Add a connector to integrate with external data sources.",
      "delete_connector_confirm": "Delete \"{name}\"?",
...
"previous": "Previous",
  ...
  "connectors": {
    "rest": {
      ...
      "on_unknown": "Connector write idempotency (ambiguous delivery)",
      ...
      "on_unknown_off": "off",
      "on_unknown_fail_open_help": "On an ambiguous prior write (delivery unconfirmed), re-fire the write — possible duplicate, usually recoverable.",
      "on_unknown_fail_closed_help": "On an ambiguous prior write, suppress the write — possible silent miss the operator must reconcile.",
      "on_unknown_off_help": "Never dedupe connector writes — the idempotency gate is bypassed entirely.",
