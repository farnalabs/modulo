export default {
  ...
  "views": {
    ...
    "AdminRemyView": {
      ...
      "tool_permissions_description": "Control which UI actions Remy can perform and whether approval is required.",
      ...
      "safety_and_limits_description": "Configure rate limits, auto-execution thresholds, and no-go patterns for Remy's browser automation.",
      "auto_execute_threshold_description": "Minimum confidence score (0.0–1.0) required for Remy to auto-execute an action without approval.",
      "save_safety_config": "Save Safety Config",
      "skills": "Skills",
      "add_skill": "Add Skill",
      "inactive": "Inactive",
      "create_skill_description": "Create a new organisation-level skill for Remy.",
    ...
    "OnboardingWizard": {
      ...
      "telemetry_can_change_later": "You can change this anytime in Admin > Telemetry."
    },
    "SettingsLicenseView": {
