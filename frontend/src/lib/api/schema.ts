...
export interface paths {
    ...
    "/api/v1/dashboard/trends": {
        ...
        /**
         * Dashboard Trends
         * @description Trend data over the specified number of days â€” run counts, eval pass rate, token spend.
         */
    ...
    "/api/v1/runs/{run_id}/nodes/{node_id}/observe": {
         ...
         *
         *     Requires operator or admin role.  Idempotent â€” observing the same
    ...
    "/api/v1/runs/{run_id}/nodes/{node_id}/recover": {
         ...
         *
         *     Two modes:
         *       * **Re-run** â€” provide ``input_data`` with the new manual output.
         *       * **Skip** â€” omit ``input_data`` (or set ``null``); the node is marked
    ...
    "/api/v1/triggers/{trigger_id}/webhook": {
         ...
         *
         *     Requires X-Modulo-Timestamp header (Unix seconds, Â±300s window).
    ...
    "/api/v1/onboarding/step": {
        ...
        put?: never;
        /** Mark Step Completed */
        post: operations["mark_step_completed_api_v1_onboarding_step_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/onboarding/step/{step_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Step Data */
        get: operations["get_step_data_api_v1_onboarding_step__step_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/environments/{profile_id}/test": {
        ...
        /**
         * Test Profile
         * @description Provision a sandbox from the profile, run echo, destroy it â€” stream events.
         */
...
export interface operations {
    ...
    mark_step_completed_api_v1_onboarding_step_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["MarkStepRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["MarkStepResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_step_data_api_v1_onboarding_step__step_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OnboardingStepDataResponse"];
                };
            };
            /** @description Validation Error */
            422: {
