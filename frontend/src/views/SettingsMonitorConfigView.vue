            ...
            >
              <div class="flex items-center justify-between">
                ...
                <label for="settingsmonitorconfigview-field-2" class="relative inline-flex items-center cursor-pointer">
                  <input id="settingsmonitorconfigview-field-2" type="checkbox" v-model="b.enabled" class="sr-only peer" :aria-labelledby="`settingsmonitorconfigview-backend-label-${b.key}`" @change="onDirty" />
