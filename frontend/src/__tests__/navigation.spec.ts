...
const mockManifest = vi.hoisted(() => ({
  ...
  routes: {
    ...
    '/evals/proposals': { name: 'eval-proposals-queue', breadcrumb: 'Eval Proposals', sidebar_group: 'monitor', sidebar_order: 3, type: 'list_page', required_tier: null, required_roles: null, required_permissions: null, visibility: 'private_preview' },
    '/variants/compare': { name: 'variant-compare', breadcrumb: 'Variants', sidebar_group: 'monitor', sidebar_order: 4, type: 'page', required_tier: null, required_roles: null, required_permissions: null, visibility: 'private_preview' },
    '/variants/ab-test': { name: 'ab-test-models', breadcrumb: 'AB Test Models', sidebar_group: 'monitor', sidebar_order: 5, type: 'page', required_tier: null, required_roles: null, required_permissions: null, visibility: 'private_preview' },
    ...
    '/settings/runtime-config': { name: 'settings-runtime-config', breadcrumb: 'Runtime Config', sidebar_group: 'configure', sidebar_order: 8, type: 'form_page', required_tier: 'team', required_roles: ['admin'], required_permissions: null },
    ...
    '/environment-profiles': { name: 'environment-profiles', breadcrumb: 'Environment Profiles', sidebar_group: 'configure', sidebar_order: 11, type: 'list_page', required_tier: 'team', required_roles: ['admin'], required_permissions: null, exact: true },
    '/admin/costs': { name: 'admin-costs', breadcrumb: 'Cost Overview', sidebar_group: 'configure', sidebar_order: 12, type: 'page', required_tier: 'team', required_roles: ['admin'], required_permissions: null, exact: true },
    '/admin/costs/limits': { name: 'admin-costs-limits', breadcrumb: 'Spend Limits', sidebar_group: 'configure', sidebar_order: 13, type: 'form_page', required_tier: 'team', required_roles: ['admin'], required_permissions: null },
    '/admin/costs/controls': { name: 'admin-costs-controls', breadcrumb: 'Cost Controls', sidebar_group: 'configure', sidebar_order: 14, type: 'form_page', required_tier: 'team', required_roles: ['admin'], required_permissions: null },
