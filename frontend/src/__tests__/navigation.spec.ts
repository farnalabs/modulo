...
const mockManifest = vi.hoisted(() => ({
  ...
  routes: {
    ...
    '/admin/runners/profiles': { name: 'admin-runners-profiles', breadcrumb: 'Runners', sidebar_group: 'configure', sidebar_order: 8, type: 'page', required_tier: 'team', required_roles: ['admin'], required_permissions: null, exact: true },
    '/admin/runners/concurrency': { name: 'admin-runners-concurrency', breadcrumb: 'Runner Concurrency', sidebar_group: null, sidebar_order: null, type: 'page', required_tier: 'team', required_roles: ['admin'], required_permissions: null },
