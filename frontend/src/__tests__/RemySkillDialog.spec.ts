...
describe('RemySkillDialog', () => {
  ...
  it('renders edit dialog when openEdit is called', async () => {
    ...
    expect((wrapper.find('[data-testid="remy-skills-form-name"]').element as HTMLInputElement).value).toBe('My Skill')
    expect((wrapper.find('[data-testid="remy-skills-form-description"]').element as HTMLTextAreaElement).value).toBe('A test skill')
    expect((wrapper.find('[data-testid="remy-skills-form-triggers"]').element as HTMLInputElement).value).toBe('trigger1, trigger2')
    expect((wrapper.find('[data-testid="remy-skills-form-body"]').element as HTMLTextAreaElement).value).toBe('# Instructions\nDo stuff')
    expect((wrapper.find('[data-testid="remy-skills-form-active"]').element as HTMLInputElement).checked).toBe(true)
  })
  ...
  it('populates form with null fields handled gracefully in openEdit', async () => {
    ...
    await nextTick()
    expect((wrapper.find('[data-testid="remy-skills-form-name"]').element as HTMLInputElement).value).toBe('Minimal')
    expect((wrapper.find('[data-testid="remy-skills-form-description"]').element as HTMLTextAreaElement).value).toBe('')
    expect((wrapper.find('[data-testid="remy-skills-form-triggers"]').element as HTMLInputElement).value).toBe('')
    expect((wrapper.find('[data-testid="remy-skills-form-body"]').element as HTMLTextAreaElement).value).toBe('')
    expect((wrapper.find('[data-testid="remy-skills-form-active"]').element as HTMLInputElement).checked).toBe(false)
  })
  ...
  it('saves a new skill via POST', async () => {
    ...
    // Fill the form
    const nameInput = wrapper.find('[data-testid="remy-skills-form-name"]')
    await nameInput.setValue('New Skill')
    const bodyInput = wrapper.find('[data-testid="remy-skills-form-body"]')
  ...
  it('parses comma-separated triggers', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Skill')
    await wrapper.find('[data-testid="remy-skills-form-triggers"]').setValue('a, b, c')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('updates an existing skill via PUT', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Updated')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('emits saved on successful create', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('New')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('does not save when name is whitespace only', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('   ')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('shows error on POST failure', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Duplicate')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('shows error when save throws', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Test')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('confirms deletion and emits saved', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-delete-confirm"]').trigger('click')
    await flushPromises()
  ...
  it('cancels deletion when cancel button is clicked', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-delete-cancel"]').trigger('click')
    await flushPromises()
  ...
  it('disables delete confirm button while deleting', async () => {
    ...
    const confirmBtn = wrapper.find('[data-testid="remy-skills-delete-confirm"]')
  ...
  it('renders custom endpoint props', async () => {
    const wrapper = mount(RemySkillDialog, {
      props: {
        createEndpoint: '/api/v1/me/remy/skills',
        updateEndpoint: '/api/v1/me/remy/skills/{skill_id}',
        deleteEndpoint: '/api/v1/me/remy/skills/{skill_id}',
      },
      global: {
        stubs: {
          Dialog: dialogStub,
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Custom')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
  ...
  it('clears saveError when opening create dialog', async () => {
    ...
    vm.openCreate()
    await nextTick()
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('X')
    await wrapper.find('form').trigger('submit')
    await flushPromises()
    expect(wrapper.text()).toContain('Failed to create skill')
  ...
  it('submit is disabled when name is empty', async () => {
    ...
    const submitBtn = wrapper.find('[data-testid="remy-skills-form-submit"]')
  ...
  it('submit is enabled when name is provided', async () => {
    ...
    await wrapper.find('[data-testid="remy-skills-form-name"]').setValue('Valid Name')
    await nextTick()
