...
function mountDrawer() {
  return mount(AssistantSessionDrawer, {
    global: {
      stubs: {
...
describe('AssistantSessionDrawer', () => {
  beforeEach(() => {
    localStorage.clear()
  ...
  it('shows loading state when sessions are loading', async () => {
    ...
    expect(wrapper.find('.assistant-session-item').exists()).toBe(false)
  })
  ...
  it('renders sorted sessions', async () => {
    ...
    const wrapper = mountDrawer()
    const items = wrapper.findAll('.assistant-session-item')
  ...
  it('selects a session on click', async () => {
    ...
    await wrapper.find('.assistant-session-item').trigger('click')
  ...
  it('deletes a session when delete button is clicked', async () => {
    ...
    await wrapper.find('.assistant-session-delete').trigger('click')
  ...
  it('formatTime returns empty string for falsy iso', async () => {
    ...
    const item = wrapper.find('.assistant-session-item')
