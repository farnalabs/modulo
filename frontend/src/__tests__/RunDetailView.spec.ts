...
describe('RunDetailView rendering extras', () => {
  ...
  it('does not render a workspace lease section (endpoint removed in FAR-587)', async () => {
  ...
  it('does not render workspace lease duration text (section removed in FAR-587)', async () => {
