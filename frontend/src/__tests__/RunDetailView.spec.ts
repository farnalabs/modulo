...
describe('RunDetailView rendering extras', () => {
  ...
  it('does not render a workspace lease section (panel removed in FAR-587, endpoint returns 410)', async () => {
  ...
  it('does not render workspace lease durations after the panel was removed (FAR-587)', async () => {
