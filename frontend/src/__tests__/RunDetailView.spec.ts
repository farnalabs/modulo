...
describe('RunDetailView rendering extras', () => {
  ...
  it('no longer renders a workspace lease section (endpoint removed in FAR-587)', async () => {
  ...
  it('does not render workspace durations after the lease endpoint was removed', async () => {
