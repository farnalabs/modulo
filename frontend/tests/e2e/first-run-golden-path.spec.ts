...
test.describe('First-Run Golden Path', { tag: "@regression" }, () => {
  ...
  test('golden path: login -> browse pipelines -> trigger run -> inspect output', { tag: '@regression' }, async ({ page, env }) => {
    ...
    // â”€â”€ Mock API responses for the full golden path â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Step 2: Navigate to pipelines list â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    await page.goto('/pipelines')
    await expect(page.locator('h1')).toContainText('Pipelines')
    await expect(page.getByTestId('pipeline-list-search')).toBeVisible()

    // â”€â”€ Step 3: Find the demo pipeline and open run dialog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const runButton = page.getByTestId('pipeline-list-run').first()
    await expect(runButton).toBeVisible({ timeout: 5000 })
    await runButton.click()

    // â”€â”€ Step 4: Trigger a run via the dialog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const submitButton = page.getByTestId('pipeline-list-run-submit')
    await expect(submitButton).toBeVisible()
    await submitButton.click()

    // â”€â”€ Step 5: Wait for navigation to run detail and inspect output â”€
    ...
    // â”€â”€ Step 6: Verify run output is visible â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
