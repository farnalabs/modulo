...
**Where:** `modulo/core/guardrails/`, `modulo/core/guardrails/config.py`, `docs/product-map/evals/eval-gates.md`, ingestion seam in `modulo.db.crud.run.create_run`.
