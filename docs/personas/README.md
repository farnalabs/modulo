...
|---|---|---|---|---|
| [Duncan](duncan-solo-developer.md) | 1 | Self (builder) | Grow complexity over time | Community → Team (if he teams up) |
| [Alice](alice-devx-sme.md) | 30–150 | Recommends (budget: VP Eng) | Model existing SDLC → replace steps one at a time | Community |
| [Priya](priya-platform-engineer.md) | 150–1,000+ | Evaluates (budget: CTO) | Centralised platform rollout team-by-team | Team |
| [Marcus](marcus-ciso.md) | 500–5,000+ | Signatory | Security governance gate; approves spend | Team |
| [Elena](elena-engineering-director.md) | 50–300 | Decision-maker | Dashboard-driven oversight and ROI | Team (for team governance) |
