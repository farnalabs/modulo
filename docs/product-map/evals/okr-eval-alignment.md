...
- [ ] Suites without an OKR ID are still trackable individually ### Progress Tracking
...
- [ ] OKR progress returned with suite_id, suite_name, current_score, pass_threshold, trend, trend_direction, days_to_target, breach ### Target Date Management
...
- [ ] No target_date returns days_to_target = None ### Breach Detection & Notification
...
- [ ] Large number of suites under one OKR — aggregation paginates or caps ### BDD Coverage
...
- [ ] Scenario: Multiple suites under one OKR show aggregate progress ## Known Gaps - No dedicated suite DB entity — suite_id is a free-form string on eval_definitions, no FK, no metadata
