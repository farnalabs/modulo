...
## Known Gaps - Team deletion checks for pipelines (admin.py:824-832) but does NOT check for stages, connectors, model backends, or library primitives — partial implementation of PRD 9.3 deletion policy
