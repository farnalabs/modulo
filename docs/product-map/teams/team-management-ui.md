...
depends-on: [task-nv1-team-entity, task-nv1-team-ownership]
status: partial
---
...
## Known Gaps
- `depends-on` references task IDs (`task-nv1-team-entity`, `task-nv1-team-ownership`) instead of feature IDs — should be feat-* IDs per product map convention
