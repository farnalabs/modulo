...
- [ ] `tier_gap_flags()` returns enterprise/v1/v2 flags that are currently inactive due to free tier ### Backend — API `GET /api/v1/admin/feature-flags`
...
- [ ] Not implemented yet — known gap ### Frontend — Lock icon on gated features (PRD Enterprise feature gate)
...
- [ ] Not implemented yet — known gap ### Frontend — License settings page (PRD License page)
...
- [ ] Not implemented yet — known gap ### States
