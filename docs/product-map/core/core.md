...
- [ ] Complete the full path in a single session turning an existing SDLC into a running pipeline

### PRD 8.4 — Manual Nodes as Onboarding Tool

- [ ] Team models existing process using manual placeholder nodes
...
- [ ] Manual node carries output_schema_id for human output validation
...
- [x] connect_tools step returns connector definitions (GitHub, Jira)
...
- [ ] 7-step wizard with numbered step indicator showing progress
...
- **Backend step data simplified:** PRD 8.16 mentions Notion/Confluence as document-store connectors in addition to Jira/GitHub; `connect_tools` step data only lists GitHub, Jira.
