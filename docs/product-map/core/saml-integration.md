...
- [ ] BDD `sso_saml.feature` ACS scenarios (2/3 of test coverage) broken — `jit_provision_user` mock in BDD steps returns single `MagicMock()` instead of `(Account, UUID, str)` tuple
