...
- [x] OTel spans emitted via LangGraph callback handler ### Edge Cases
...
- [ ] Lock wait timeout: run queued behind another on same pipeline/agent → timeboxed or indefinite? ### Error Handling
