...
- [ ] **MR operations limited**: no MR diff/changed-files listing, MR approval request, or MR approval-request flow (merge, approve, comment, note, and labels now implemented)
