...
- [ ] §10.2 Plugin / Extension API — Python entry-point groups for connectors, evals, model backends, schema types
- [ ] §10.3 First-Run Experience — Pre-loaded demo pipeline, guided walkthrough, MODULO_DEMO_MODE
- [ ] §10.3a Alpha Documentation — dev-setup.md, architecture.md, CONTRIBUTING.md
...
- [ ] §10.5 Opt-In Telemetry — OTel bridge enabled via MODULO_TELEMETRY_ENABLED, off by default
