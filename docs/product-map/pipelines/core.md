...
- [x] Folder parent updates reject self-parenting and ancestry cycles via `_assert_valid_parent` in `pipeline_folder.py` — invalid parent assignments return 422
