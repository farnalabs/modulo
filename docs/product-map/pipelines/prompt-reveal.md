...
- [x] SQLAlchemyError (connection/deadlock failure) returns 503 Service Unavailable
- [x] Generic Python Exception returns 500 Internal Server Error
- [x] Logged on SQLAlchemyError and generic Exception
