...
| License model | BSL/Fair Source — source-available, free for non-commercial/individual use, commercial enterprise use requires paid license key. Each version auto-converts to Apache 2.0 three years after release. Flat annual fee; no telemetry billing. |
