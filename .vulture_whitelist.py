...
__all__ = [
    ...
    # FAR-602 HITL email compose — exercised by tests/unit/core/test_hitl_email_alerts.py;
    # the production path (schedule_hitl_email_dispatch -> _run_hitl_email_dispatch)
    # splits resolve/send, so vulture cannot see a prod call site
